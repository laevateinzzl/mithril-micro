...
mkdir -p ${GO_OUT_PATH}
protoc -I=$PROTO_PATH --go_out=paths=source_relative:$GO_OUT_PATH user_srv.proto
protoc -I=$PROTO_PATH --go-grpc_out=paths=source_relative:$GO_OUT_PATH user_srv.proto
protoc -I=$PROTO_PATH --grpc-gateway_out=paths=source_relative,grpc_api_configuration=$PROTO_PATH/user_srv.yaml:$GO_OUT_PATH user_srv.proto