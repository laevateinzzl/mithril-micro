...
func RegisterVideoServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server VideoServiceServer) error {
	...
	mux.Handle("POST", pattern_VideoService_CreateVideo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/vsrv.pb.video.VideoService/CreateVideo", runtime.WithHTTPPathPattern("/video"))
		if err != nil {
...
func RegisterVideoServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client VideoServiceClient) error {
	...
	mux.Handle("POST", pattern_VideoService_CreateVideo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/vsrv.pb.video.VideoService/CreateVideo", runtime.WithHTTPPathPattern("/video"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_VideoService_CreateVideo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"video"}, ""))
)
